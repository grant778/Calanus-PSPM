  ...
  
{
  ...
  Spring = log(1000*as.numeric(c(Spring_Mean_Juvenile_Biomass,
                        Spring_Mean_Adult_Biomass)))
  Summer = log(1000*as.numeric(c(Summer_Mean_Juvenile_Biomass,
  ...
  output1_1_non_trivial_.096 <-PSPMequi(modelname = "Scripts/StageStructuredBiomass_GW_Calanus_max_ingestion_temp_dependent_V5_9_15_2023.R", 
                                        ...
                                        stepsize = 0.75, parbnds = c(1, output1_1_A_hat_.096$bifpoints[1], 10000), parameters = Modified_Parameters_A_hat_.096, 
  ...
  DF3_Summer = DF3[which(DF3[,"name"] == "Spring"),]
...
Delta_Vector = .1 #seq(.1,1,.1) 

Rmax_Vector = 2000 #seq(1900,1950,10) #2000
#A_Hat_Vector = seq(0.035,.065,.01) 
A_Hat_Vector = .096 #c(0.092,.096)

alpha_Vector = seq(0.74,0.82,0.01)

Mopt_Vector = seq(40,100,10)
