...
output1_1_A_hat_.096 <-PSPMequi(modelname = "Scripts/StageStructuredBiomass_GW_Calanus_max_ingestion_temp_dependent_V5.R", biftype = "EQ", startpoint = c(0.05, 0.05), 
                                stepsize = 1,
                                parbnds = c(1, 0, 4000), parameters = Modified_Parameters_A_hat_.096, minvals = NULL, maxvals = NULL, options = c(c("popZE", "0")),
...
output1_1_non_trivial_.096 <-PSPMequi(modelname = "Scripts/StageStructuredBiomass_GW_Calanus_max_ingestion_temp_dependent_V5.R", 
                                      ...
                                      stepsize = .025, parbnds = c(1, output1_1_A_hat_.096$bifpoints[1], 4000), parameters = Modified_Parameters_A_hat_.096, 
...
start_.096 = min(which(t1[,"Rmax"] < (Modified_Parameters_A_hat_.096[2]+150) & t1[,"Rmax"] > (Modified_Parameters_A_hat_.096[2]-150)))
...
Rmax_Vector = seq(1500, 2500, 100)
Delta_Vector = seq(.1,10.1,1)
iter = 0
