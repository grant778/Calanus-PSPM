...
#     1 : Resource biomass (zooplankton) [0]
#     2 : Juvenile Predator biomass [1]
#     3 : Adult Predator biomass [2]
# 
#     
...
#     2 : Total biomass of zooplankton [1]
#     3 : Juvenile fish grazing rate [2]
#     4 : Adult fish grazing rate [3]
#     5 : Total biomass of fish juveniles [4]
#     6 : Total biomass of fish Adults [5]
...
#Model environmental state variables:
  ...
  #     1 : Resource biomass (for zooplankton) [0]
  #     2 : Juvenile Predator biomass [1]
  #     3 : Adult Predator biomass [2]
  #     4 : zooplankton (prey) biomass [3]
  #     5 : Temperature [4] Temperature isn't a state variable since it doesn't vary over time.  Just on different model runs.  So don't use here as environmental state variable.
  #   
  
EnvironmentState <- c(R = "GENERALODE", Pj = "PERCAPITARATE", Pa = "PERCAPITARATE", Bv = "POPULATIONINTEGRAL")

#Pa equals adult predator density
#Pj equals juvenile predator density
#Bv = zooplankton biomass
...
DefaultParameters <- c(Rmax = NULL,
                       Temp = NULL, 
                       M = NULL,
                       mb = NULL, #Mass of fish at birth
                       #mzb = NULL, #Mass of zooplankton at birth
                       mj = NULL, #Mass where fish becomes adult
                       Imax = NULL, 
                       cI = 0,
                       cM = NULL,
                       rI = NULL,
