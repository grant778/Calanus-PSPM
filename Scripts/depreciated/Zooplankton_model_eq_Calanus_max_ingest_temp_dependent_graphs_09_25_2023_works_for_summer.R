...
DefaultParameters <- c(Delta =  .01, #turnover rate is 1 divided by the per capita growth rate
...
ggplot()+
 ...
 A_A_hat_Net_Production = Net_Production_A_hat_.096_A
  ...
  Temperature_A_Hat[which(Fecundity_A_Hat <= 0)]
