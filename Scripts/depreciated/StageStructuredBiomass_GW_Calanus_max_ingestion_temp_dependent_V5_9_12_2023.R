...
DefaultParameters <- c(Delta =  1, #turnover rate is 1 divided by the per capita growth rate
                       ...
                       #Im = 29.89,
                       Im = 11.26, #fit from kiorbe et al 2018 formulation of ingestion with alpha = .75
                       ...
                       sigma = .854 , # .6 (Kiørboe, 2008.) Converts ingested energy to biomass
                       #assimilation efficiencies between .685 and .854 Landry et al. 2984
                       Mopt = 195, #???????????
