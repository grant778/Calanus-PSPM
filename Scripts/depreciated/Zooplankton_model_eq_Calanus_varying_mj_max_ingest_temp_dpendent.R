...
output1_1_Temp_283 <-PSPMequi(modelname = "Scripts/StageStructuredBiomass_GW_Calanus_max_ingestion_temp_dependent_V5.R", biftype = "EQ", startpoint = c(0.05, 0.05), stepsize = 0.1,
...
output1_1_Temp_275 <-PSPMequi(modelname = "Scripts/StageStructuredBiomass_GW_Calanus_max_ingestion_temp_dependent_V5.R", biftype = "EQ", startpoint = c(0.05, 0.05), stepsize = 0.1,
...
output1_1_non_trivial_Temp_283 <-PSPMequi(modelname = "Scripts/StageStructuredBiomass_GW_Calanus_max_ingestion_temp_dependent_V5.R", 
...
output1_1_non_trivial_Temp_275 <-PSPMequi(modelname = "Scripts/StageStructuredBiomass_GW_Calanus_max_ingestion_temp_dependent_V5.R", 
...
output1_1_non_trivial_varying_mj_Temp_283 <-PSPMequi(modelname = "Scripts/StageStructuredBiomass_GW_Calanus_max_ingestion_temp_dependent_V5.R", 
                                                          biftype = "EQ", startpoint = c(exp(-3.18)*exp(.73*12) , output1_1_non_trivial_Temp_283$curvepoints[81,2], 
                                                          output1_1_non_trivial_Temp_283$curvepoints[81,3]), 
                                                          stepsize = -.5,
                                                          parbnds = c(27, 0, exp(-3.18)*exp(.73*12)), parameters = Modified_Parameters_Temp_283, minvals = NULL, maxvals = NULL, 
                                                          clean = TRUE, force = FALSE, debug = FALSE, silent = FALSE)
  
output1_1_non_trivial_varying_mj_Temp_275 <-PSPMequi(modelname = "Scripts/StageStructuredBiomass_GW_Calanus_max_ingestion_temp_dependent_V5.R", 
                                                          biftype = "EQ", 
                                                          startpoint = c(exp(-3.18)*exp(.73*12), output1_1_non_trivial_Temp_275$curvepoints[86,2], output1_1_non_trivial_Temp_275$curvepoints[86,3]), 
                                                          stepsize = -1,
