...
Delta_Vector =  1 #seq(0.2,1,.2) 

Rmax_Vector = seq(1600,2000,200) 
#A_Hat_Vector = seq(0.035,.065,.01) 
A_Hat_Vector = 0.096

alpha_Vector = .75 #seq(0.70,0.78,0.02)

Mopt_Vector = seq(150,250,50)
